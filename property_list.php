...
<body>
  ...
  <?php require "./includes/header.php"; ?>
    ...
    <div class="page-container">
        ...
        ?>
              ...
              <div class="property-card row">
                  <div class="image-container col-md-4">
                      <?php
                        $img_q = mysqli_query($con, "SELECT image_path FROM property_images WHERE property_id=$pg_id LIMIT 1");
                        $img = $img_q ? mysqli_fetch_assoc($img_q) : null;
                        $thumbPath = ($img && !empty($img["image_path"])) ? $img["image_path"] : "assets/bg2.png";
                      ?>
                      <img src="<?php echo $thumbPath; ?>" style="width:100%; height:180px; object-fit:cover; border-radius:8px;" />
                  </div>
                  <div class="content-container col-md-8">
                          ...
                          <div class="property-gender">
                              ...
                              <?php
                                if( $gender_allowed=='male' ){
                                  ?> <img src="assets/male.png" /> <?php
                                }
                                elseif( $gender_allowed=='female' ){
                                  ?> <img src="assets/female.png" /> <?php
                                }
                                else{
                                  ?> <img src="assets/unisex.png" /> <?php
                                }
                              ?>
                      ...
                      <div class="row no-gutters">
                          ...
                          <div class="button-container col-6 d-flex flex-column">
                              <a href="property_detail.php?property_id=<?php echo $pg_id; ?>" class="btn btn-primary mb-2">View</a>
                              <a href="booking.php?property_id=<?php echo $pg_id; ?>" class="btn btn-outline-success btn-sm">Book Now</a>
                          </div>
                      </div>
                  </div>
              </div>
        ...
        <!-- <div class="property-card row">
            <div class="image-container col-md-4">
                <img src="assets/properties/1/eace7b9114fd6046.jpg" />
            </div>
            <div class="content-container col-md-8">
                <div class="row no-gutters justify-content-between">
        ...
        <div class="property-card row">
            <div class="image-container col-md-4">
                <img src="assets/properties/1/46ebbb537aa9fb0a.jpg" />
            </div>
            <div class="content-container col-md-8">
                <div class="row no-gutters justify-content-between">
